...
CC="${CLANG_INSTALL_DIR}/bin/clang -v -ccc-host-triple arm-none-linux-gnueabi -ccc-gcc-name arm-none-linux-gnueabi-gcc --sysroot=/opt/arm-2011.03/arm-none-linux-gnueabi/libc"
